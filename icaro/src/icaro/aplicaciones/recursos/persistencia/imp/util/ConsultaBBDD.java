...
public class ConsultaBBDD {
	...
	/**
	 * Realiza una conexion (principio de la comunicación) sobre la bbdd
	...
	/**
	 * Realiza la desconexion (fin de la comunicación) sobre la bbdd
	 * @throws ErrorEnRecursoException
	 */
	...
	public static void desconectar() {
		...
		try	{
			...
			System.out.println("\nNo se ha podido cerrar la conexión con la base de datos: " + e.getMessage());
			e.printStackTrace();
		}
	 ...
	 * @throws Exception Si ocurre un fallo de conexión
	 */
