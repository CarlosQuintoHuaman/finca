...
import icaro.aplicaciones.recursos.visualizacionAcceso.imp.usuario.UsoAgenteAcceso;
...
public class PanelAccesoUsuario extends VentanaEstandar{
			...
			private UsoAgenteAcceso usoAgente; //comunicación con el agente (control)
			
			
			public PanelAccesoUsuario(ClaseGeneradoraVisualizacionAcceso visualizador) {
				usoAgente = new UsoAgenteAcceso(visualizador);
				initComponents();
		    	...
		    	this.addWindowListener(new WindowAdapter()
				{
		    		public void windowClosing(WindowEvent e)
		    		{
		    			...
		    			JOptionPane.showMessageDialog(null,"Como el control está en el agente, la ventana no podrá cerrar el sistema directamente.\n Si " +
		    										  "quisiéramos que esto ocurriera, deberíamos enviar un Evento y modificar el autómata del Agente.");
		    		}
				});
