package icaro.infraestructura.recursosOrganizacion.repositorioInterfaces.impLocal;
...
public class RepositorioInterfacesImpLocal extends RepositorioInterfaces {
	 ...
	 */ 
	  ...
	  public Object obtenerInterfaz(String nombre) 
	  {
	    if ( !this.repositorio.containsKey(nombre) ){
	      System.err.println("RepositorioInterfaces: No se pudo recuperar "+nombre+" porque no existe ningún objeto con ese nombre");
	      ...
	      System.out.println("RepositorioInterfaces: No se pudo recuperar "+nombre+" porque no existe ningún objeto con ese nombre");
	  ...
	  public synchronized void eliminarRegistroInterfaz(String nombre)
	  {
	    ...
	    if (this.repositorio.containsKey(nombre))
	    {
	      ...
	      if(DEBUG) System.out.println("Se eliminó la referencia a "+nombre+" del repositorio de interfaces.");
	    }
	    else
	      if(DEBUG) System.out.println("Se intentó eliminar la referencia "+nombre+" del repositorio, pero no estaba definida.");
	  }
