...
public class TablaEstadosControl {
	 ...
	 *
	 *@return    Devuelve el estado inicial del autómata
	 */
	 ...
	 *  estado
	 *
	 *@param  estadoActual  Estado en el que se está
	 *@param  input         Input que se ha recibido
	 *@return               Operación que hay que realizar( y estado siguiente )
	 */
	...
	/**
	 *  Añade un nuevo estado a la tabla
	 *
	...
	public void putEstado(String identificador, int tipo)
	{
		...
		// aceleramos la recuperación del estado inicial
	...
	/**
	 *  Añade una nueva transición de estados a la tabla
	 *
	 *@param  estado           Estado desde el que parte la transición
	 *@param  accion           Acción que se ejecuta
	 *@param  estadoSiguiente  Estado al que se pasa tras ejecutar la transición
	 *@param  input            Input que activa la transición
	...
	public void putTransicion(String estado, String input, String accion, String estadoSiguiente, String modo)
	{
		...
		// añadimos el nuevo input
		inputsDeUnEstado.put(input, operacion);
	}


	/**
	 *  Añade la transición indicada como parámetro a todos los estados del
	 *  autómata PRE: El autómata debe estar completamente creado ( todos los
	 *  estados añadidos ) NOTA: En caso de existir inputs repetidos, se dejará
	 *  intacto el input ya existente
	 *
	 *@param  input      input de la transición universal
	 *@param  accion     acción a ejecutar en la transición universal
	 *@param  estadoSig  estado al que llegamos tras la transición universal
	 *@param  modo       modo de ejecución de la acción
	 */
	public void putTransicionUniversal(String input, String accion, String estadoSig, String modo)
	{
		// esta operación tenemos que añadírsela a todos los estados de la tabla
		...
		while (iteradorClaves.hasMoreElements())
		{
			...
			// añadimos la transición si no es estado final y el input no estaba en ese estado
