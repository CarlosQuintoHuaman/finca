...
public class UsoAgenteMedicamentos {
    ...
    public void cargaFinalizada(Composite c) {
    	...
    	try {
            ...
            itfUsoMedico.aceptaEvento(new EventoRecAgte("mostrarTabMed", c, "VisualizacionMedicamentos1", "AgenteAplicacionMedico1"));
    ...
    public void asignarMed(String p, InfoMedicamento m) {
    	...
    	try {
            ...
            itfUsoMedicamentos.aceptaEvento(new EventoRecAgte("asignarMedicamento", d, "VisualizacionMedicamentos1", "AgenteAplicacionMedicamentos1"));
    ...
    public void insertarMed(String origen, InfoMedicamento m) {
    	...
    	try {
            ...
            ItfUsoAgenteReactivo itfUsoMedicamentos = (ItfUsoAgenteReactivo)itfUsoRepositorioInterfaces.obtenerInterfaz("Itf_Uso_AgenteAplicacionMedicamentos1");
            itfUsoMedicamentos.aceptaEvento(new EventoRecAgte("insertarMedicamento", m, "VisualizacionMedicamentos1", "AgenteAplicacionMedicamentos1"));
            ...
            itfUsoMedicamentos.aceptaEvento(new EventoRecAgte("cargarMedicamentos", origen, "VisualizacionMedicamentos1", "AgenteAplicacionMedicamentos1"));
    ...
    public void notificacionCierreSistema() {
         try {
             nombreAgenteMedicamentos = visualizador.getNombreAgenteControlador();
            usoAgenteControlador = (ItfUsoAgenteReactivo) ClaseGeneradoraRepositorioInterfaces.instance().obtenerInterfaz(nombreAgenteMedicamentos);
        } catch (Exception ex) {
        ...
        try {
            ...
            if (tipoAgenteMedicamentos.equals(NombresPredefinidos.TIPO_REACTIVO)) {
                ...
                if (itfUsoAgente != null) {
                    itfUsoAgente.aceptaEvento(new EventoRecAgte("peticion_terminacion_usuario", "VisualizacionFicha", nombreAgenteMedicamentos));
                }
            }
        } catch (Exception e) {
