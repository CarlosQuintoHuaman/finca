...
public class PanelAccesoAltaUsuario extends VentanaEstandar {
			...
			private NotificacionesAgenteAccesoAlta usoAgente; //comunicaci�n con el agente (control)
			
			
			public PanelAccesoAltaUsuario(ClaseGeneradoraVisualizacionAccesoAlta visualizador)throws Exception  {
				usoAgente = new NotificacionesAgenteAccesoAlta(visualizador);
				initComponents();
