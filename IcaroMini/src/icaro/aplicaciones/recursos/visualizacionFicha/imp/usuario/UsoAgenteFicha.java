...
public class UsoAgenteFicha {
    ...
    public void notificacionCierreSistema() {
         try {
             nombreAgenteFicha = visualizador.getNombreAgenteControlador();
            usoAgenteControlador = (ItfUsoAgenteReactivo) ClaseGeneradoraRepositorioInterfaces.instance().obtenerInterfaz(nombreAgenteFicha);
        } catch (Exception ex) {
        ...
        try {
            ...
            if (tipoAgenteFicha.equals(NombresPredefinidos.TIPO_REACTIVO)) {
                ...
                if (itfUsoAgente != null) {
                    itfUsoAgente.aceptaEvento(new EventoRecAgte("peticion_terminacion_usuario", "VisualizacionFicha", nombreAgenteFicha));
                }
            }
        } catch (Exception e) {
    ...
    public void mostrarVentanaCita(String nombre, String apellido, String telf){
    	...
    	try {
            ...
            if (tipoAgenteFicha.equals(NombresPredefinidos.TIPO_REACTIVO)) {
                ...
                ItfUsoAgenteReactivo itfUsoAgente = (ItfUsoAgenteReactivo) itfUsoRepositorioInterfaces.obtenerInterfaz(NombresPredefinidos.ITF_USO + nombreAgenteFicha);
                if (itfUsoAgente != null) {
                    itfUsoAgente.aceptaEvento(new EventoRecAgte("darCita", datosEnvio, "VisualizacionFicha1", nombreAgenteFicha));
                }
            }
    ...
    public void guardarFicha(DatosFicha original, DatosFicha fichaN){
    	...
    	try {
            ...
            if (tipoAgenteFicha.equals(NombresPredefinidos.TIPO_REACTIVO)) {
                ...
                ItfUsoAgenteReactivo itfUsoAgente = (ItfUsoAgenteReactivo) itfUsoRepositorioInterfaces.obtenerInterfaz(NombresPredefinidos.ITF_USO + nombreAgenteFicha);
                if (itfUsoAgente != null) {
                    itfUsoAgente.aceptaEvento(new EventoRecAgte("guardarFicha", fichas, "VisualizacionFicha1", nombreAgenteFicha));
                }
            }
    ...
    public void borrarFicha(DatosFicha ficha){
    	...
    	try {
            ...
            if (tipoAgenteFicha.equals(NombresPredefinidos.TIPO_REACTIVO)) {
                ...
                ItfUsoAgenteReactivo itfUsoAgente = (ItfUsoAgenteReactivo) itfUsoRepositorioInterfaces.obtenerInterfaz(NombresPredefinidos.ITF_USO + nombreAgenteFicha);
                if (itfUsoAgente != null) {
                    itfUsoAgente.aceptaEvento(new EventoRecAgte("borrarFicha", ficha, "VisualizacionFicha1", nombreAgenteFicha));
                }
            }
    ...
    public void cerrarVentanaFicha(){
    	...
    	try {
            ...
            if (tipoAgenteFicha.equals(NombresPredefinidos.TIPO_REACTIVO)) {
                ...
                ItfUsoAgenteReactivo itfUsoAgente = (ItfUsoAgenteReactivo) itfUsoRepositorioInterfaces.obtenerInterfaz(NombresPredefinidos.ITF_USO + nombreAgenteFicha);
                if (itfUsoAgente != null) {
                    itfUsoAgente.aceptaEvento(new EventoRecAgte("cerrarVentanaFicha", "VisualizacionFicha1", nombreAgenteFicha));
                }
            }
	   ...
	   getInformacionAgente();
        ...
        try {
            ...
            if (tipoAgenteFicha.equals(NombresPredefinidos.TIPO_REACTIVO)) {
                ...
                ItfUsoAgenteReactivo itfUsoAgente = (ItfUsoAgenteReactivo) itfUsoRepositorioInterfaces.obtenerInterfaz(NombresPredefinidos.ITF_USO + nombreAgenteFicha);
                if (itfUsoAgente != null) {
                    itfUsoAgente.aceptaEvento(new EventoRecAgte("infoCita", datosEnvio, "VisualizacionFicha1", nombreAgenteFicha));
                }
            }
    ...
    public void crearAgenteFicha() {
    	...
    	try {
            ...
            itfUsoFicha.aceptaEvento(new EventoRecAgte("comenzar", "VisualizacionFicha1", "AgenteAplicacionFicha1"));
