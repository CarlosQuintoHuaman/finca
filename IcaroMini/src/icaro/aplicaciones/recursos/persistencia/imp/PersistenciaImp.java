...
public class PersistenciaImp extends ImplRecursoSimple implements
		ItfUsoPersistencia {
	...
	public PersistenciaImp(String id) throws Exception {
	...
	public boolean compruebaUsuario(String usuario, String password)
		...
		try {
		trazas.aceptaNuevaTraza(new InfoTraza("Persistencia",
