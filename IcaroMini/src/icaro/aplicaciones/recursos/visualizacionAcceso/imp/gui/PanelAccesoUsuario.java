...
import icaro.aplicaciones.recursos.visualizacionAcceso.imp.NotificacionesAgenteAcceso;
...
public class PanelAccesoUsuario extends VentanaEstandar{
			 ...
			 */
			private NotificacionesAgenteAcceso usoAgente; //comunicaci�n con el agente (control)
			
			
			public PanelAccesoUsuario(ClaseGeneradoraVisualizacionAcceso visualizador) {
				usoAgente = new NotificacionesAgenteAcceso(visualizador);
				initComponents();
