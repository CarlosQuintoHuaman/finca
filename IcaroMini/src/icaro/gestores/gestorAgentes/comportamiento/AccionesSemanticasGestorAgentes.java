        ...
        try {
            ...
            if (nodoDestino.equals(esteNodo)) {
                ...
                while (!ok) {
                    ++intentos;
                    try {
                        ((FactoriaAgenteReactivo) ClaseGeneradoraRepositorioInterfaces.instance().obtenerInterfaz(
            ...
            ((ItfGestionAgenteReactivo) ClaseGeneradoraRepositorioInterfaces.instance().obtenerInterfaz(NombresPredefinidos.ITF_GESTION + nombreAgente)).setGestorAReportar(
