...
/**
 *  Buzón de objetos con funcionalidades de consumo no bloqueante
 *
...
public class Buzon implements Itf_ProductorBuzonTimeout, Itf_ConsumidorBuzonTimeout {
	...
	/**
	 * Tamaño máximo que tendrá la cola
		...
		throws ExcepcionTimeOutSuperado
	{
		...
		if (timeout.isAlive())
		{
		    timeout.activo = false;
		     // Corrección al problema: Si no interrumpimos el timeout se queda en el sleep hasta que acaba y luego,
		     // como ya no está activo ni siquiera genera el evento, la solución es interrumpir
		     // la hebra para que termine su método run y se consiga reciclar, con ello
	...
	/**
	 *  Introduce un nuevo evento en el buzón, se ignoran nuevos eventos si el
	 *  buzón no está activo
	 *
	 ...
	 *
	 *@return    nº de elementos que contiene el buzón
	 */
	...
	/**
	 *  Elimina todos los elementos del buzón
	 */
	...
	*/
        ...
        /**
         * Interrumpe el buzón introduciendo un evento de timeout
         */
