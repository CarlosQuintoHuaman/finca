...
import icaro.herramientas.descripcionorganizacion.modelo.TipoAgente;
...
//    protected AccionesSemanticasImp accionesSemanticas;
	...
	//		Se obtienen los parametros y se crean los subcomponentes utilizando las factorias
     ...
     //     itfGesControl = (InterfazGestion) control.getProcesadorEventos();
		...
		AgenteReactivoAbstracto patron = new AgenteReactivoImp(nombreInstanciaAgente,itfGestionControlAgteReactivo,itfProductorPercepcion,itfConsumidorPercepcion);
